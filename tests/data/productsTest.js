...
describe('test suite: oop product', product)
describe('test suite: oop clothing', testClothing)
describe('test suite: oop appliance', testAppliance)
...
function product() {
  ...
  it('tests the product main info', () => {
    console.log(product)
  ...
  it('tests the product local methodes', () => {
...
function testClothing() {
  ...
  it('tests the product sizeChart', () => {
